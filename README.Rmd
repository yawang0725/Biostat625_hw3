...
-   **Handling outliers:** Options for removing or replacing outliers based on the Interquartile Range (IQR). -**Scaling numeric data:** Option to scale the numeric columns to have zero mean and unit variance.
