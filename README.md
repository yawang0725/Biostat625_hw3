...
```
    ...
    ## ── R CMD build ─────────────────────────────────────────────────────────────────
    ##      checking for file ‘/private/var/folders/sm/fyc9dlf55jj62vtb6dynb6640000gn/T/Rtmp3HMbH6/remotes915d309ce842/yawang0725-Biostat625_hw3-25dd40e/DESCRIPTION’ ...  ✔  checking for file ‘/private/var/folders/sm/fyc9dlf55jj62vtb6dynb6640000gn/T/Rtmp3HMbH6/remotes915d309ce842/yawang0725-Biostat625_hw3-25dd40e/DESCRIPTION’
    ##   ─  preparing ‘hw3’:
...
```
    ...
    ## Skipping install of 'hw3' from a github remote, the SHA1 (25dd40ed) has not changed since last install.
...
```
    ...
    ## 1 lm_result  227.4µs 240.1µs     4074.    47.6KB     24.2  1853    11      455ms
    ## 2 custom_re…  76.5µs  81.9µs    12004.    32.8KB     17.1  5602     8      467ms
