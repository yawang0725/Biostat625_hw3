...
```
    ...
    ## ── R CMD build ─────────────────────────────────────────────────────────────────
    ##      checking for file ‘/private/var/folders/sm/fyc9dlf55jj62vtb6dynb6640000gn/T/Rtmp96yPR4/remotes929a33a6505b/yawang0725-Biostat625_hw3-28d8f1f/DESCRIPTION’ ...  ✔  checking for file ‘/private/var/folders/sm/fyc9dlf55jj62vtb6dynb6640000gn/T/Rtmp96yPR4/remotes929a33a6505b/yawang0725-Biostat625_hw3-28d8f1f/DESCRIPTION’
    ##   ─  preparing ‘hw3’:
...
```
    ...
    ## Skipping install of 'hw3' from a github remote, the SHA1 (28d8f1f9) has not changed since last install.
...
```
    ...
    ## 1 lm_result   229.7µs  253µs     3279.    47.6KB     19.8  1493     9      455ms
    ## 2 custom_res…  76.5µs   82µs    11792.    32.8KB     17.2  5478     8      465ms
